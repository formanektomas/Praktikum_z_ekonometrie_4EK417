...
%---------------------------------------------------------------------
\begin{frame}
\frametitle{Block 2: Spatial analysis \& spatial models -- Outline} % Table of contents slide, comment this block out to remove it
...
\smallskip
\item For spagial models, $LR$ tests may be applied more generally (different restrictions may be evaluated).
\end{itemize}
\end{frame}
%---------------------------------------------------------------------
