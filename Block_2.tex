...
%---------------------------------------------
\begin{frame}{Regression splines}
Linear spline regression model with $K$ knots $\xi_k, k=1,\dots, K$ can be represented using \textcolor{blue}{basis functions} as follows:
...
\begin{itemize}
    ...
    \smallskip
    \item With linear splines, each knot only adds one estimated parameter to the estimation (compare to non-continuous piecewise linear regression).
    \smallskip
