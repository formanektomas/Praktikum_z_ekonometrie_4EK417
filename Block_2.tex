...
\begin{itemize}
    ...
    \smallskip
    \item Unfortunately, $d$-splines (incl. cubic splines) tend to have high variance at the outer range of the predictor (i.e. when $X$ is very low or very high). Possible solution: use ``natural splines'' with additional bounary constraints.
\end{itemize}
\end{frame}
%---------------------------------------------
