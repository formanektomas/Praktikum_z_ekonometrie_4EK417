...
%
%
\title[Spatial analysis]{Spatial Analysis} % The short title appears at the bottom of every slide, the full title is only on the title page

\author{Tomáš Formánek} % Your name
\institute[2019] % Your institution as it will appear on the bottom of every slide, may be shorthand to save space
{
% Your institution for the title page
\medskip
\textit{Seminar held at: Universidad del País Vasco, Bilbao, 2019} % Your email address
}
